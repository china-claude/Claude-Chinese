...
[Claude 中文版](https://ai.lanjingai.org) 是Anthropic Claude模型的本地化中文应用版本，专为中国用户量身优化，带来高效、流畅的AI对话体验。  
...
| **蓝鲸AI**             | [ai.lanjingai.org](https://ai.lanjingai.org/)                                 | Claude 4 Sonnet/Thinking  | 邮箱注册使用，有免费额度         | 支持Claude、GPT、Gemini全系，深度集成deepseek r1，附带PPT生成、AI绘图等实用工具            |
...
| **AI助理**             | [ai.lanjingai.org](https://ai.lanjingai.org/)                         | Claude 4 Sonnet           | 邮箱注册使用，有免费额度              | 纯中文界面、无广告、极致简洁                                                             |
